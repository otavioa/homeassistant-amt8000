...
`raw-status` detalha o frame completo, separando cabeçalho, comando, checksum e os blocos do payload: modelo, firmware, máscaras de zonas, estado global, partições, falha/tamper/bateria de sirene RF (SDK), tamper e bateria.
